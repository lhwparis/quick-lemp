...
sudo add-apt-repository 'deb [arch=amd64,i386,ppc64el] http://ftp.hosteurope.de/mirror/mariadb.org/repo/10.1/ubuntu xenial main'
...
# PHP 7.x
apt-get -q -y install php7.0-fpm php7.0-common php7.0-curl php7.0-gd php7.0-cli php-pear php7.0-imap php7.0-mcrypt php7.0-opcache php7.0-json php7.0-mbstring php7.0-dom php7.0-zip
...
echo
if [[ $REPLY =~ ^[Yy]$ ]]; then
apt-get -q -y install php5.6-fpm php5.6-common php5.6-curl php5.6-gd php5.6-cli php-pear php5.6-imap php5.6-mcrypt php5.6-opcache php5.6-json php5.6-mbstring php5.6-dom php5.6-zip
